...
class Account extends Component {
  ...
  getAccountDependencies(accountId) {
    axios.get(`/accountDependencies/${accountId}`).then(results => {
  ...
  getContributors(contributorIds) {
    axios
      .post(`/contributors`, { contributors: contributorIds })
      .then(results => {
        this.setState({
  ...
  getProcesses(processIds) {
    axios.post(`/processes`, { processes: processIds }).then(results => {
      this.setState({
