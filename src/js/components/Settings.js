...
class Settings extends Component {
  ...
  getAccounts() {
    axios.get("/accounts").then(results => {
  ...
  getModules() {
    axios.get("/modules").then(results => {
      this.setState({
  ...
  createNewItem(activeKey) {
    if (activeKey === "users") {
      ...
      axios.post("/newUser", newUser).then(() => {
      ...
      axios.post("/createModule", { module: this.state.newModule }).then(() => {
        ...
        <Tab.Container id="left-tabs-example" defaultActiveKey="users">
          <Row>
            <Col sm={3} className="settingsTabs">
              ...
              >
                <Nav.Item>
                  <Nav.Link eventKey="users" className="tab">
                    Users
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="modules" className="tab">
                    Modules
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="accounts" className="tab">
                    Accounts
                  </Nav.Link>
                </Nav.Item>
              </Nav>
